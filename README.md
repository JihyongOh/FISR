...
* **Running the FISR_for_video option** will read all **.png** files (YUV format) in the designated folder and save the predicted FISR results in .png format (RGB format) in **\<source_path\>/FISR_test_folder/scene1/FISR_frames**. 
